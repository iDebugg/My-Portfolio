    ...
    <div id='about' className='about display: flex flex-col justify-center items-center pr-3 pl-3 sm:pr-4 sm:pl-4 md:pr-6 md:pl-6 lg:pr-8 lg:pl-8'>
        ...
        <div className="about-achievements mt-10">
            <div className="about-achievement text-center">
                <h1 data-aos="flip-left"  className='text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl'>3+</h1>
                <p data-aos="flip-right" data-aos-delay="100" className='text-md sm:text-md md:text-xl lg:text-2xl xl:text-2xl'>YEARS OF EXPERIRNCE</p>
            </div>
            <hr />
            <div className="about-achievement text-center">
                <h1 data-aos="flip-right" data-aos-delay="100" className='text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl'>10+</h1>
                <p data-aos="flip-left" className='text-md sm:text-md md:text-xl lg:text-2xl xl:text-2xl'>PROJECTS COMPLETED</p>
            </div>
            <hr />
            <div className="about-achievement text-center">
