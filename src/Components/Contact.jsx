  ...
  return (
    <div id="contact" className="contact display: flex flex-col justify-center items-center pr-3 pl-3 sm:pr-4 sm:pl-4 md:pr-6 md:pl-6 lg:pr-8 lg:pl-8 mt-20 mb-20">
      <div className="contact-title">
        <h1 data-aos="flip-up" className="text-4xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-7xl">Get in touch</h1>
      </div>
      <div className="contact-section grid grid-cols-1 sm:grid-cols-2 lg:flex gap-8">
        <div data-aos="slide-up" className="contact-left display: flex flex-col gap-4">
        ...
        <form data-aos="flip-up" onSubmit={onSubmit} className="contact-right display: flex flex-col items-start gap-4">
